  ...
  <div class="mySpace">
    <div class="bgc">
     ...
     <!-- <div class="info" v-show="userId" >
      ...
      <div class="bottom"><el-button type="primary" @click="toEdit()"  v-show="userId">确认修改</el-button></div>
      <div class="bottom"><el-button type="primary" @click="allEdit()"  v-show="!userId">立即创建</el-button></div>
    </div>
  </div>
</template>
...
//          this.postFile(this.file,'HEADPIC',userId,userId);
      ...
      allEdit(){
        ...
        var type_id  = this.getUser.type_id ;
