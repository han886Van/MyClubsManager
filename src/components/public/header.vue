      ...
      <li class="left">
        ...
        <!-- <div class="my_new">
         ...
         <el-autocomplete
                 ...
                 placeholder="请输入内容"
                 @select="handleSelect">
             <i class="iconfont icon-wxbsousuotuiguang" slot="suffix" @click="handleIconClick">
             </i>
    ...
    methods: {
      ...
      outLogin() {
        this.$confirm('是否退出系统?', '提示', {
          ...
          var url = this.localhost+'associationMg/user/loginOut';
